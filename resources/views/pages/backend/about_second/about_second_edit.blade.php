    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{ url('about-second-update/'.$data6->id) }} " method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <label for="name">name</label>
                      <input type="text" name="name" class="form-control" id="name" aria-describedby="emailHelp" value="{{ $data6->name }}">

                    </div>
                    <div class="form-group">
                      <label for="position">Position</label>
                      <input type="text" name="position" class="form-control" id="position" value="{{ $data6->position }}">
                    </div>
                    <div class="form-group">
                        <label for="dis">Discribtion</label>
                        <input type="text" name="dis" class="form-control" id="dis" value="{{ $data6->dis }}">
                      </div>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="facebook" class="form-control" id="facebook" value="{{ $data6->facebook }}" required>
                      </div>
                      <div class="form-group">
                        <label for="twitter">twitter link</label>
                        <input type="text" name="twitter" class="form-control" id="twitter" value="{{ $data6->twitter }}" required>
                      </div>
