    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{ url('home-third-update/'.$data11->id) }} " method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="dis" class="form-control" id="dis"  value="{{ $data11->dis }}">
                    </div>
                    {{-- <div class="form-group">
