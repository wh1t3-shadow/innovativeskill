        ...
        <div class="main-panel">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="col">{{ $data1->course }}</th>
                        <th scope="col">{{ $data1->name }}</th>
                        <th scope="col">{{ $data1->email }}</th>
                        <th scope="col">{{ $data1->number }}</th>
                        <th scope="col">{{ $data1->addres }}</th>
                        <th scope="col">{{ $data1->occupation }}</th>



                       <td><a class="btn btn-warning" href="enroll-delete/{{ $data1->id }}">Delete</a></td>
