                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST"
                                            ...
                                            <select class="form-control" aria-label="Default select example"
                                                ...
                                                @foreach ($courseInfo as $course)
                                                    <option value="{{ $course->id }}"
                                                        @if ($course->id == $courseContent->course_title_id) selected @endif>
                                    ...
                                    <div class="form-group">
                                        <label for="courseContentLink">Course Content</label>
                                        <input type="text" class="form-control" id="courseContentLink"
