    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{ url('home-second-update/'.$data7->id) }} " method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <label for="title">Title</label>
                      <input type="text" name="title" class="form-control" id="title" aria-describedby="emailHelp" value="{{ $data7->title }}">

                    </div>
                    <div class="form-group">
                      <label for="dis">Discribtion</label>
                      <input type="text" name="dis" class="form-control" id="dis"  value="{{ $data7->dis }}">
                    </div>
                    {{-- <div class="form-group">
