    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{ url('/home-forth-submit') }} " method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <label for="title">Iframe</label>
                      <input type="text" name="iframe" class="form-control" id="title" aria-describedby="emailHelp" placeholder="https://www.youtube.com/embed/62COBCy6mO8">

                    </div>

                    <div class="form-group">
                        <label for="dis">Video thumbnail</label>
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($data14 as $data14)
                    <tr>
                      <th>{{ $data14->id }}</th>
                      <td>{{ $data14->iframe }}</td>
                      <td><a class="btn btn-warning" href="home-forth-delete/{{ $data14->id }}">Delete</a></td>
