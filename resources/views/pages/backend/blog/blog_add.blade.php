    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{ url('/blog-submit') }} " method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="courseTitle"> Select Catagory</label>
                        <div class="col-sm-9">
                            <select class="form-control" aria-label="Default select example"
                                style="color: black" name="catagory_id" id="courseTitle">
                                <option selected value="">Select catagory</option>
                                @foreach ($data3 as $data3)
                                    <option value="{{ $data3->id }}">{{ $data3->catagory }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $data5->title }}</td>
                      <td>{{ $data5->dis }}</td>
                      <td><img src="{{ url('images/'.$data5->image) }}" alt="image"></td>

                      <td><a class="btn btn-warning" href="blog-edit/{{ $data5->id }}">Edit</a></td>
                      <td><a class="btn btn-warning" href="blog-delete/{{ $data5->id }}">Delete</a></td>
